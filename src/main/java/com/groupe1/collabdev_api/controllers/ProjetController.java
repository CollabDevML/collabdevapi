...
@Tag(name = "ADMIN API",
        description = "Gestion CRUD sur le projet")
...
public class ProjetController {
    ...
    @Operation(summary = "pour afficher un seul projet")
    @GetMapping("/projets/{id}")
    public Projet afficherUnProjet(@PathVariable int id) {
        return projetService.chercherParId(id);
    }

    @Operation(summary = "pour afficher les projets d'un gestionnaire")
    ...
    @Operation(summary = "pour afficher un seul projet d'un gestionnaire")
    ...
    @Operation(summary = "pour modifier un projet")
